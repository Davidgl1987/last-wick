...
//
// Las FAMILIAS de suelo (`FLOOR_FAMILIES`), `pickFloorFamily` (qué familia le
// toca a una sala) y `pickFloorTile` (qué variante le toca a una baldosa
// concreta) viven en `floor-families.ts` — módulo puro compartido con
// `room-props.ts`/`RoomPropsView.tsx`, que necesita la MISMA familia para
// decidir qué decals de suelo puede salpicar sobre ella (ver el comentario de
