 ...
 * 1 foso, pinchos, 2 barriles (a distancia de cadena), 2 monedas, 1 poción
 * y 1 llave.
 *
 * Distribución (de sur a norte):
 * - Sur: inicio del jugador, flanqueado por monedas.
 * - Centro: Dummy y Trail patrullando, rocas para carambolas, y el Spike
 *   custodiando el paso central.
